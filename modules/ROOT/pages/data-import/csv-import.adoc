...
* xref:data-import/import-desktop-csv.adoc[How-To: Import CSV data with Neo4j Desktop]
...
* xref:data-import/import-desktop-csv.adoc#inspect-files[Cypher] - what Cypher sees is what will be imported, so you can use that to your advantage.
